...
import { FEEDBACK_TARGET_TYPE_ARRAY, FeedbackTargetType, FEEDBACK_STATUS_ARRAY, FeedbackStatus } from '@shared/constants'


export const feedbackStatusEnum = pgEnum('feedback_status', FEEDBACK_STATUS_ARRAY);

export const targetTypeEnum = pgEnum('target_type', FEEDBACK_TARGET_TYPE_ARRAY);
...
export const feedbacks = pgTable('feedbacks', {
    ...
    targetDesc: varchar('target_desc', { length: 255 }),
...
export type Feedback = typeof feedbacks.$inferSelect & { targetType: FeedbackTargetType, status: FeedbackStatus };
export type NewFeedback = typeof feedbacks.$inferInsert & { targetType: FeedbackTargetType, status: FeedbackStatus };
